rule testDA:
   ...
   input:
      tsv="data/tmp/diff/pairwise–{sample}–{group}–minAbd{minabund}minR{minread}minS{minsample}–{theTest}/{pairwiseCats}.tsv",
      map="data/tmp/diff/pairwise–{sample}–{group}–minAbd{minabund}minR{minread}minS{minsample}–{theTest}/{pairwiseCats}.txt"
   output:
...
rule EffSizePowerTest:
   conda:
      "../../workflow/envs/DAtest.yaml"
   input:
      tsv="data/tmp/diff/{sample}–{group}–minAbd{minabund}minR{minread}minS{minsample}/{theTest}–pairwise/{pairwiseCats}.tsv",
      map="data/tmp/diff/{sample}–{group}–minAbd{minabund}minR{minread}minS{minsample}/{theTest}–pairwise/{pairwiseCats}.txt"
   output:
...
### the effect size in here and link it to the configuration file
...
rule testDA_Power_plot: 
   ...
   output: 
      ...
      labels={
              ...
              "Data type": "svg file"})
   log: 
      "data/logs/testDA_Power_plot{sample}–{group}–minAbd{minabund}minR{minread}minS{minsample}.txt"
...
rule testDA_Power_test: 
   ...
   input:
      mytable ="data/diff/{sample}–{group}–minAbd{minabund}minR{minread}minS{minsample}/AUC_FDR_Power.txt"
   output:
      dunnfile=report("data/diff/{sample}–{group}–minAbd{minabund}minR{minread}minS{minsample}/Dunn.tsv",
      caption="../report/DAtest_subject_test.rst",
      category="Differential abundance – {sample} – {group}",
      labels={
...
rule diff:
   input: #first for effect size and second is testDA
      expand("data/diff/{sample}–{group}–minAbd{minabund}minR{minread}minS{minsample}/Dunn.tsv", sample=config["mysample"],group=config["group"],theTest=config["DA_tests"],minabund=config["DA_minabund"],minread=config["DA_minread"],minsample=config["DA_minsample"],effectSize=config["DA_effectSize"]),
