...
rule diff:
   input:
      expand(         "tmp/testDA_{sample}–{group}–{theTest}–minAbd{minabund}minR{minread}minS{minsample}–done.txt", sample=config["mysample"],group=config["group"],minabund=config["DA_minabund"],minread=config["DA_minread"],minsample=config["DA_minsample"],theTest=["msf","ere2","qpo","ere","vli","per","ltt2","adx","ttc","ttt","wil","adx","ltt","tta","ttr","ds2","sam","ds2x","znb","abc","zpo","poi","neb","lic","lli2","lli","erq","erq2","lia","bay"]),
      expand(   "tmp/testDA_Power_{sample}–{group}–{theTest}–minAbd{minabund}minR{minread}minS{minsample}–done.txt", sample=config["mysample"],group=config["group"],minabund=config["DA_minabund"],minread=config["DA_minread"],minsample=config["DA_minsample"],theTest=["msf","ere2","qpo","ere","vli","per","ltt2","adx","ttc","ttt","wil","adx","ltt","tta","ttr","ds2","sam","ds2x","znb","abc","zpo","poi","neb","lic","lli2","lli","erq","erq2","lia","bay"]),
      expand("tmp/EffSizePowerTest{sample}–{group}–{theTest}–minAbd{minabund}minR{minread}minS{minsample}–done.txt", sample=config["mysample"],group=config["group"],minabund=config["DA_minabund"],minread=config["DA_minread"],minsample=config["DA_minsample"],theTest=["msf","ere2","qpo","ere","vli","per","ltt2","adx","ttc","ttt","wil","adx","ltt","tta","ttr","ds2","sam","ds2x","znb","abc","zpo","poi","neb","lic","lli2","lli","erq","erq2","lia","bay"])
