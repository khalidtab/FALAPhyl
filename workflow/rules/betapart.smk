...
rule betapart_pairwise_draw:
   ...
   output:
      report("data/plots/betapart_pairwise/{sample}–{distance}–{group}/{i}.svg",caption="../report/betapart_plot.rst",category="pairwise",subcategory="{distance}")
   log: 
...
rule jaccard_breakdown:
   input:
      expand("tmp/betapart–{distance}–{sample}–{group}.txt",  sample=config["mysample"],group=config["group"],distance="jaccard")