...
echo -e "\033[0;36msnakemake include_biom_and_meta alpha beta breakdown diff network paired_beta paired_alpha paired_diff --use-conda --cores all --keep-going --retries 5 --rerun-incomplete --scheduler greedy \033[0m"
